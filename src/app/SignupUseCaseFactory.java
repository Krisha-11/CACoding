...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createUserDeleteUseCase(viewManagerModel, signupViewModel, userDataAccessObject);
    ...
    private static ClearController createUserDeleteUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, ClearUserDataAccessInterface clearUserDataAccessObject) {
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(viewManagerModel, signupViewModel);
        ClearInputBoundary userClearInteractor = new ClearInteractor(clearUserDataAccessObject, clearOutputBoundary);
